...
router.delete("/:coachProfileId", authMiddleware, coachController.deleteProfile)

// Certification routes
router.post("/:coachProfileId/certifications", authMiddleware, coachController.addCertification)
...
router.patch("/batches/:batchId", authMiddleware, validateUpdateBatch, validateRequest, coachController.updateBatch)
...
router.delete("/batches/:batchId/students/:userId", authMiddleware, coachController.removeStudentFromBatch)

// Batch payment routes
router.get("/batches/:batchId/payments", authMiddleware, coachController.getBatchPayments)
router.post(
