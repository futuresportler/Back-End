...
const AcademyBill = require("./models/postgres/academy/academyBill")(sequelize);
...
const defineAssociations = () => {
  ...
  AcademyProgram.belongsToMany(CoachProfile, {
    through: AcademyCoach,
    foreignKey: "programId",
  });
  AcademyProgram.belongsToMany(AcademyStudent, {
    through: AcademyBill,
    foreignKey: "programId",
  });
