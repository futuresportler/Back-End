...
async function createProfile(module, supplierId, data) {
  ...
  switch (module) {
    case "coach": return await CoachRepo.createCoachProfile(payload);
    case "academy": return await AcademyRepo.createAcademyProfile(payload);
    case "turf": return await TurfRepo.createTurfProfile(payload);
...
async function updateProfile(module, profileId, data) {
  switch (module) {
    case "coach": return await CoachRepo.updateCoachProfile(profileId, data);
    case "academy": return await AcademyRepo.updateAcademyProfile(profileId, data);
    case "turf": return await TurfRepo.updateTurfProfile(profileId, data);
    default: throw new Error("Invalid module");
  }
}
...
async function deleteProfile(module, profileId) {
  switch (module) {
    case "coach": return await CoachRepo.deleteCoachProfile(profileId);
    case "academy": return await AcademyRepo.deleteAcademyProfile(profileId);
    case "turf": return await TurfRepo.deleteTurfProfile(profileId);
    default: throw new Error("Invalid module");
  }
}
